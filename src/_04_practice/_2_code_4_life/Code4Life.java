...
public class Code4Life {
	...
	public static void main(String[] args) {
		...
		String hrs = JOptionPane.showInputDialog("How much time have you spent coding this week");
		...
		if (hrsInt > 5) {
			//JOptionPane.showMessageDialog(null, "src/_04_practice/_2_code_4_life/batman.wav");
			playBatmanTheme();
			displayBatman();
	...
	private static void playBatmanTheme() {
		// NOTE: Download batman.wav from league-sounds on GitHub:
		// https://github.com/jointheleague/league-sounds
		// Then put batman.wav into the "_2_code_4_life" project
		// If you want to play a different audio, change the file name in the code
		// below.
		if (canPlaySounds) {
